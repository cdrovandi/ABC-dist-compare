...
% plot data and results for dataset 2
...
load('results_mcmc_cvm_d2.mat')
theta_cvm = theta(1:1000:end,:);

load('results_mcmc_wass_d2.mat')
theta_wass = theta(1:1000:end,:);

load('results_mcmc_aux_d2.mat')
theta_aux = theta(1:1000:end,:);

load('results_mcmc_bsl_d2.mat')
theta_bsl = theta(1:10:end,:);

xlower = [318 0.087 -0.05 34 -1 -10 -1];
xupper = [326 0.11 0.45 38 8 60 4];
