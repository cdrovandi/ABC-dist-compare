...
MAKEFILE = esim2_mex.mk

include esim2_mex.mki
...
MEX_FILE_NAME_WO_EXT = esim2_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/esim2"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/esim2/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/esim2/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/esim2/%.cu
	$(CC) $(CCFLAGS) "$<"
