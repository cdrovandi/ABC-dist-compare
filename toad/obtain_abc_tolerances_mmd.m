...
% code to obtain hyperparameters of ABC discrepancy function based on MMD distance
...
for i=1:100000
    ...
    dist1(i) = MMD_dist(x{1,2},y{1,2});
    dist2(i) = MMD_dist(x{2,2},y{2,2});
    dist3(i) = MMD_dist(x{3,2},y{3,2});
    dist4(i) = MMD_dist(x{4,2},y{4,2});
