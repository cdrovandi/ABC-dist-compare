...
for i=1:100000
    ...
    dist1(i) = Wass_stat_M(log(x{1,2}),log(y{1,2}),1);
    dist2(i) = Wass_stat_M(log(x{2,2}),log(y{2,2}),1);
    dist3(i) = Wass_stat_M(log(x{3,2}),log(y{3,2}),1);
    dist4(i) = Wass_stat_M(log(x{4,2}),log(y{4,2}),1);
