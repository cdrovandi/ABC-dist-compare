...
% code to obtain hyperparameters of ABC discrepancy function based on MMD distance (for log transformed data)
...
for i=1:100000
    ...
    dist1(i) = MMD_dist(log(x{1,2}),log(y{1,2}));
    dist2(i) = MMD_dist(log(x{2,2}),log(y{2,2}));
    dist3(i) = MMD_dist(log(x{3,2}),log(y{3,2}));
    dist4(i) = MMD_dist(log(x{4,2}),log(y{4,2}));
