...
% code to obtain hyperparameters of ABC discrepancy function based on Wass distance
...
for i=1:100000
    ...
    dist1(i) = Wass_stat_M(x{1,2},y{1,2},1);
    dist2(i) = Wass_stat_M(x{2,2},y{2,2},1);
    dist3(i) = Wass_stat_M(x{3,2},y{3,2},1);
    dist4(i) = Wass_stat_M(x{4,2},y{4,2},1);
