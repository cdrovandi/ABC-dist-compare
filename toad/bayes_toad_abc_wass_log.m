...
for i = 1:M
    ...
    dist_prop = sum(w.*[Wass_stat_M(log(x{1,2}),log(y{1,2}),1) Wass_stat_M(log(x{2,2}),log(y{2,2}),1) Wass_stat_M(log(x{3,2}),log(y{3,2}),1) Wass_stat_M(log(x{4,2}),log(y{4,2}),1) abs(x{1,1} - y{1,1}) abs(x{2,1} - y{2,1}) abs(x{3,1} - y{3,1}) abs(x{4,1} - y{4,1})]);
